...
public class KotlinEvaluatorTest {
  ...
  private static EvaluationObjectFactory evaluationObjectFactory;
  ...
  public static void setUp() throws Exception {
    ...
    kernel = new KotlinKernelMock("id", evaluator);
    KernelManager.register(kernel);
    evaluationObjectFactory = new SimpleEvaluationObjectFactory();
  ...
  public void javaImports_shouldBeAdjustedForKotlin() throws Exception {
    ...
    EvaluationObject seo = evaluationObjectFactory.createSeo(code, kernel, HEADER_MESSAGE, 1);
